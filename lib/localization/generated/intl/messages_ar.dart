...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "demoFillExamples": MessageLookupByLibrary.simpleMessage("تعبئة الأمثلة"),
    "demoFormCompletionAndSavedValuesSubtitle":
        MessageLookupByLibrary.simpleMessage("قيم الإكمال وFormState.save()"),
    "demoFormResultTitle": MessageLookupByLibrary.simpleMessage(
      "نتيجة النموذج",
    ),
    ...
    "demoValidateAndSave": MessageLookupByLibrary.simpleMessage("تحقق واحفظ"),
    ...
    "otpPinTitle": MessageLookupByLibrary.simpleMessage("رقم PIN آمن للمعاملة"),
    ...
    "otpTransactionPinLabel": MessageLookupByLibrary.simpleMessage(
      "رقم PIN للمعاملة",
    ),
    "otpVerificationCodeHelper": MessageLookupByLibrary.simpleMessage(
      "تم إرسال رمز من ستة أرقام إلى هاتفك.",
    ),
    "otpVerificationCodeHint": MessageLookupByLibrary.simpleMessage(
      "أدخل الرمز المرسل عبر SMS",
    ),
    "otpVerificationCodeLabel": MessageLookupByLibrary.simpleMessage(
      "رمز التحقق",
    ),
    "phoneCountryRulesSubtitle": MessageLookupByLibrary.simpleMessage(
      "ادمج نوع الهاتف مع البادئة والقناع والنمط",
    ),
    "phoneCountryRulesTitle": MessageLookupByLibrary.simpleMessage(
      "قواعد خاصة بالدولة",
    ),
    "phoneDemoCardSubtitle": MessageLookupByLibrary.simpleMessage(
      "دولي · قواعد الدولة · المنسقات · حفظ النموذج",
    ),
    "phoneDemoCardTitle": MessageLookupByLibrary.simpleMessage(
      "حقل رقم الهاتف",
    ),
    "phoneDemoEyebrow": MessageLookupByLibrary.simpleMessage(
      "حقل نصي • إدخال الهاتف",
    ),
    "phoneDemoTitle": MessageLookupByLibrary.simpleMessage("أمثلة حقل الهاتف"),
    "phoneInternationalHelper": MessageLookupByLibrary.simpleMessage(
      "يقبل الأرقام والمسافات والأقواس وعلامة + والشرطات.",
    ),
    "phoneInternationalHint": MessageLookupByLibrary.simpleMessage(
      "مثال: ‎+1 (415) 555-0132",
    ),
    "phoneInternationalResultLabel": MessageLookupByLibrary.simpleMessage(
      "الدولي",
    ),
    "phoneInternationalSubtitle": MessageLookupByLibrary.simpleMessage(
      "لوحة مفاتيح الهاتف مع الرموز الدولية الشائعة",
    ),
    "phoneInternationalTitle": MessageLookupByLibrary.simpleMessage("رقم دولي"),

...
// (numerics). Color is left null so each style inherits the surrounding `fg*`
// token — pass `.copyWith(color: t.fg1)` at the call site.
// ============================================================
...
abstract final class SuperText {
  /// H1 page title — Manrope 26 / 700 / -0.025em.
  ...
  /// Body copy / input text — Inter 14 / 400.
  ...
  /// Eyebrow — wider tracking variant of [label] (~0.15em).
  ...
  /// Placeholder / hint / caption — Inter 12 / 400.
  ...
  /// Numerics / serials / file sizes — JetBrains Mono 14 / 400, tabular.

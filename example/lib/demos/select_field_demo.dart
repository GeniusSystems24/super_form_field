      ...
      children: [
            ...
            children: [
              BilingualRow(
                english: SuperSelectFormField<String>(
                  ...
                  required: true,
                  source: const SuperSelectListSource<String>(items: _accountTypes),
                ...
                arabic: SuperSelectFormField<String>(
                  ...
                  required: true,
                  arabic: true,
                  source: const SuperSelectListSource<String>(items: _arabicAccountTypes),
              ...
              SuperSelectFormField<String>(
                ...
                clearable: true,
                initialValue: 'SAR',
                source: const SuperSelectListSource<String>(items: _currencies),
        ...
        SuperSectionCard1(
          ...
          child: const SuperSelectFormField<String>(
            ...
            clearable: true,
            source: SuperSelectListSource<String>(items: _costCenters),
